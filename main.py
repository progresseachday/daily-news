...
def generate_wall_street_facts_summary(raw_corpus):
    ...
    prompt = (
        "# Role\n"
        "你現在是華爾街頂級私募基金的常務董事。你擁有極其嚴謹的金融大局觀。\n\n"
        "# Task\n"
        "請審視今日所有 RSS 新聞文本，挖掘出核心數字，並套用正統經濟學邏輯進行深度判讀。\n\n"
        "【⚠️ 至高赤字禁令 —— 違者開除】\n"
        "1. 🚨【語言命令】所有輸出的文字一律必須使用【繁體中文（台灣習慣用語）】！絕對不准留下一句英文原始文本！必須由你將英文完全翻譯並精煉成台灣人能秒讀的中文！\n"
        ...
        "<p style='margin: 12px 0; font-size: 14px;'>● <b>[繁體中文事件名稱]</b>：[將當天新聞 facts 完全翻譯成中文大意] <span style='color: #0f766e; font-weight: 500;'>➔【投行判讀】[用投資學理論判斷此數據對市場的利基]</span> <a href='對應網址' style='color: #007bff; text-decoration: none;'>🔗 原文連結</a></p>\n\n"
        "<h3>🌍 地緣政治與跨境供應鏈（營運韌性視角）</h3>\n"
        "<p style='margin: 12px 0; font-size: 14px;'>● <b>[繁體中文事件名稱]</b>：[中文 facts 大意] <span style='color: #0f766e; font-weight: 500;'>➔【投行判讀】[產業衝擊分析]</span> <a href='對應網址' style='color: #007bff; text-decoration: none;'>🔗 原文連結</a></p>\n\n"
        "<h3>💡 AI 前沿突破與新創資本（商業化視角）</h3>\n"
        "<p style='margin: 12px 0; font-size: 14px;'>● <b>[繁體中文項目名稱]</b>：[中文 facts 大意] <span style='color: #0f766e; font-weight: 500;'>➔【投行判讀】[商業競爭護城河分析]</span> <a href='對應網址' style='color: #007bff; text-decoration: none;'>🔗 原文連結</a></p>\n\n"
        f"--- 當天原始 RSS 數據文本 ---\n{raw_corpus}"
    )
